...
function AssemblyTemplatesPage() {
    ...
    const fetchTemplates = async () => {
        ...
        try {
            ...
            const response = await api.get('/assembly-templates', { params });
    ...
    const handleClone = async (templateId) => {
        try {
            ...
            await api.post(`/assembly-templates/${templateId}/clone`, {
                createdById: userId
            });
    ...
    const handleDelete = async (templateId) => {
        try {
            await api.delete(`/assembly-templates/${templateId}`);
            ...
            render: (_, record) => (
                <Space size="small">
                    <Button
                        type="link"
                        icon={<EditOutlined />}
                        onClick={() => navigate(`/assembly-templates/${record.id}`)}
                    >
                        Editar
                    </Button>
                    <Button
            ...
            <Card
                ...
                extra={
                    <Button
                        type="primary"
                        icon={<PlusOutlined />}
                        onClick={() => navigate('/assembly-templates/new')}
                    >
                        Nueva Plantilla
                    </Button>
                }
...
export default AssemblyTemplatesPage;
