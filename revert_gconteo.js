...
const oldCode = `    let outputTargets = note?.productionBatch?.outputTargets || [];
...
const newCode = `    const outputTargets = note?.productionBatch?.outputTargets || [];
...
console.log('Reverted GConteoCarritosStep.jsx filter');
